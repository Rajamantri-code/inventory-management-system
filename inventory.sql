...
(6, '2023-09-22', 'mr.abc', 123456789, 1, 'abc', 1, 100, 13, 5, 107.35, 105, 2.35, 'cash', 'partial');
...
INSERT INTO `product` (`product_id`, `product_name`, `quantity`, `rate`, `brand_id`, `category_id`, `active`, `status`) VALUES
(1, 'abc', 6, 100, 1, 1, 1, 1),
(2, 'abc1', 15, 150, 2, 2, 1, 1);
